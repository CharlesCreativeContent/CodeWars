...
let G1 = good.split(' ').map(Number)
let E1 = evil.split(' ').map(Number)
let G2 = [G1[0], G1[1]*2, G1[2]*3, G1[3]*3, G1[4]*4, G1[5]*10]
let E2 = [E1[0], E1[1]*2, E1[2]*2, E1[3]*2, E1[4]*3, E1[5]*5, E1[6]*10]
if (G2.reduce((a,b)=>a+b)<E2.reduce((a,b)=>a+b)){
return "Battle Result: Evil eradicates all trace of Good"
}else if(G2.reduce((a,b)=>a+b)>E2.reduce((a,b)=>a+b)){
